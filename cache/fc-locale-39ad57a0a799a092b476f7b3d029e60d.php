<?php return array (
  ...
  'user.orcid' => 'ORCID iD',
  'user.orcid.description' => 'ORCID iDs can only be assigned by <a href="http://orcid.org/" target="_blank">the ORCID Registry</a>. You must conform to their standards for expressing ORCID iDs, and include the full URI (eg. <em>http://orcid.org/0000-0002-1825-0097</em>).',
  'user.profile.form.orcidInvalid' => 'The ORCID iD you specified is invalid.',
  'user.profile.implicitAuthChangePasswordInstructions' => 'If you have logged in via your Shibboleth, follow your organization\'s process if you need to change your password.  For local users, continue below.',
  ...
  'issue.viewIssueDescription' => 'View or download the full issue',
...
<p>The system could not automatically overwrite the configuration file. To apply your configuration changes you must open <tt>config.inc.php</tt> in a suitable text editor and replace its contents with the contents of the text field below.</p>',
  ...
  'manager.setup.preservationDescription' => 'Open Journal Systems supports the <a href="http://www.lockss.org/" target="_blank">LOCKSS</a> (Lots of Copies Keep Stuff Safe) system to ensure secure and permanent preservation of your journal. You have several options for including your journal in a LOCKSS network:',
  'manager.setup.lockssDescription' => '<strong>PKP Private LOCKSS Network</strong>
<p>Any OJS journal that has an ISSN and has published at least one article can choose to agree to the terms of use and be preserved in the PKP PLN at no cost.</p>
<p>To join, go to <a href="{$genericPluginsUrl}">Generic Plugins</a>, find PKP PLN Plugin, select Enable, and then select Settings, and accept the Terms of Use. Your content will then be automatically included in the network. No further action is required.</p>
<strong>Other LOCKSS Networks</strong>
<p>If you believe you have access to one or more of the LOCKSS networks listed <a href="http://www.lockss.org/community/networks/" target="_blank">here</a>, please contact the appropriate LOCKSS Network administrator to apply for inclusion. Completing the form below will allow for inclusion of your journal in those networks. <em>No content will be preserved before you have notified the appropriate network</em>.</p>',
  'manager.setup.authorCopyrightNotice.sample' => '<h3>Examples of Creative Commons Licensing Notifications in the Copyright Notices</h3>
...
current password.<br /><br />Enter your email address below to reset your password. A confirmation will be sent to this email address.',
  ...
  'user.register.emailValidation' => 'Email Validation Required',
  'user.register.emailValidationDescription' => 'You are required to validate your email address before proceeding. Please check your email account for further instructions. Once you have validated your account, you may login.',
  ...
  'user.register.implicitAuth' => 'Login via Shibboleth with an existing organization account',
  ...
  'search.syntaxInstructions' => '<h4>Search tips: </h4><ul>
...
<li>Use <strong>*</strong> in a term as a wildcard to match any sequence of characters; e.g., <em>soci* morality</em> would match documents containing "sociological" or "societal"</li>
  ...
  'about.purchaseIssue' => 'Issue Purchase',
  'about.purchaseArticle' => 'Article Purchase',
  'about.purchaseIssueDescription' => 'Readers without a subscription may still purchase individual issues. The following payment options and fees are available.',
  'about.purchaseArticleDescription' => 'Readers without a subscription may still purchase individual articles. The following payment options and fees are available.',
...
<ul>
	...
	<li><a href="http://www.mysql.com/" target="_blank">MySQL</a> >= 4.1 or <a href="http://www.postgresql.org/" target="_blank">PostgreSQL</a> >= 7.1 (including PostgreSQL 8.x)</li>
...
<p>If you have questions or comments, please visit the <a href="http://forum.pkp.sfu.ca" target="_new">support forum</a>.</p>',
...
Validation may fail on search URLs that require posted form data.',
  ...
  'notification.type.copyeditComment' => 'A copyeditor has left a comment on "{$title}".',
  ...
  'notification.type.layoutComment' => 'A comment has been left about "{$title}\'s" layout.',
  ...
  'notification.type.proofreadComment' => 'A comment has been left by a proofreader on "{$title}".',
  ...
  'notification.type.suppFileModified' => '"{$title}\'s" supplementary file(s) has been modified.',

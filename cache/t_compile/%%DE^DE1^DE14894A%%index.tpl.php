<?php /* Smarty version 2.6.26, created on 2018-06-30 13:36:06
         compiled from editor/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'editor/index.tpl', 17, false),array('function', 'url', 'editor/index.tpl', 20, false),array('function', 'call_hook', 'editor/index.tpl', 24, false),array('function', 'html_options_translate', 'editor/index.tpl', 57, false),array('function', 'html_select_date', 'editor/index.tpl', 70, false),array('function', 'sort_search', 'editor/index.tpl', 89, false),array('function', 'print_issue_id', 'editor/index.tpl', 114, false),array('function', 'page_info', 'editor/index.tpl', 138, false),array('function', 'page_links', 'editor/index.tpl', 139, false),array('modifier', 'escape', 'editor/index.tpl', 53, false),array('modifier', 'date_format', 'editor/index.tpl', 105, false),array('modifier', 'truncate', 'editor/index.tpl', 107, false),array('modifier', 'strip_tags', 'editor/index.tpl', 108, false),array('block', 'iterate', 'editor/index.tpl', 100, false),)), $this); ?>
...
<form method="post" id="submit" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('path' => 'search'), $this);?>
">
...
" class="action"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['submission']->getLocalizedTitle())) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('truncate', true, $_tmp, 60, "...") : $this->_plugins['modifier']['truncate'][0][0]->smartyTruncate($_tmp, 60, "...")); ?>
		...
		<td align="right">
			...
			<?php elseif ($this->_tpl_vars['status'] == STATUS_PUBLISHED): ?>
				<?php echo $this->_plugins['function']['print_issue_id'][0][0]->smartyPrintIssueId(array('articleId' => $this->_tpl_vars['submission']->getId()), $this);?>

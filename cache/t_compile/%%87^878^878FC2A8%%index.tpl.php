<?php /* Smarty version 2.6.26, created on 2018-05-10 09:45:07
         compiled from about/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'about/index.tpl', 16, false),array('function', 'url', 'about/index.tpl', 19, false),array('function', 'call_hook', 'about/index.tpl', 27, false),array('block', 'iterate', 'about/index.tpl', 23, false),array('modifier', 'escape', 'about/index.tpl', 24, false),)), $this); ?>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.contact"), $this);?>
	...
	<?php endif; ?>
	<li id="editorialTeamLink"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editorialTeam'), $this);?>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.delayedOpenAccess"), $this);?>
		...
		<?php if ($this->_tpl_vars['paymentConfigured'] && $this->_tpl_vars['journalSettings']['journalPaymentsEnabled'] && $this->_tpl_vars['journalSettings']['acceptSubscriptionPayments'] && $this->_tpl_vars['journalSettings']['purchaseIssueFeeEnabled'] && $this->_tpl_vars['journalSettings']['purchaseIssueFee'] > 0): ?><li><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editorialPolicies','anchor' => 'purchaseIssue'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.purchaseIssue"), $this);?>
</a></li><?php endif; ?>
		<?php if ($this->_tpl_vars['paymentConfigured'] && $this->_tpl_vars['journalSettings']['journalPaymentsEnabled'] && $this->_tpl_vars['journalSettings']['acceptSubscriptionPayments'] && $this->_tpl_vars['journalSettings']['purchaseArticleFeeEnabled'] && $this->_tpl_vars['journalSettings']['purchaseArticleFee'] > 0): ?><li><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editorialPolicies','anchor' => 'purchaseArticle'), $this);?>

<?php /* Smarty version 2.6.26, created on 2018-04-28 19:22:55
         compiled from search/search.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'search/search.tpl', 23, false),array('function', 'translate', 'search/search.tpl', 31, false),array('function', 'call_hook', 'search/search.tpl', 33, false),array('function', 'html_options', 'search/search.tpl', 46, false),array('function', 'page_info', 'search/search.tpl', 189, false),array('function', 'page_links', 'search/search.tpl', 190, false),array('modifier', 'assign', 'search/search.tpl', 23, false),array('modifier', 'parse_url', 'search/search.tpl', 24, false),array('modifier', 'parse_str', 'search/search.tpl', 24, false),array('modifier', 'strtok', 'search/search.tpl', 25, false),array('modifier', 'escape', 'search/search.tpl', 25, false),array('modifier', 'strip_unsafe_html', 'search/search.tpl', 137, false),array('modifier', 'to_array', 'search/search.tpl', 160, false),array('block', 'iterate', 'search/search.tpl', 125, false),)), $this); ?>
...
<div id="search">
	...
	<form id="searchForm" action="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['searchFormUrl'])) ? $this->_run_mod_handler('strtok', true, $_tmp, "?") : strtok($_tmp, "?")))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
">

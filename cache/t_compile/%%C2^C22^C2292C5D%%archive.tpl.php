<?php /* Smarty version 2.6.26, created on 2018-05-10 09:45:24
         compiled from issue/archive.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'iterate', 'issue/archive.tpl', 17, false),array('modifier', 'escape', 'issue/archive.tpl', 27, false),array('modifier', 'strip_unsafe_html', 'issue/archive.tpl', 41, false),array('modifier', 'nl2br', 'issue/archive.tpl', 41, false),array('function', 'url', 'issue/archive.tpl', 38, false),array('function', 'translate', 'issue/archive.tpl', 38, false),array('function', 'page_info', 'issue/archive.tpl', 52, false),array('function', 'page_links', 'issue/archive.tpl', 53, false),)), $this); ?>
...
<?php $this->_tag_stack[] = array('iterate', array('from' => 'issues','item' => 'issue')); $_block_repeat=true;$this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	...
	<div id="issue-<?php echo $this->_tpl_vars['issue']->getId(); ?>
" style="clear:left;">
	<?php if ($this->_tpl_vars['issue']->getFileName($this->_tpl_vars['locale'])): ?>
		<?php $this->assign('coverLocale', ($this->_tpl_vars['locale'])); ?>
	<?php else: ?>
		<?php $this->assign('coverLocale', ($this->_tpl_vars['primaryLocale'])); ?>
	<?php endif; ?>
	<?php if ($this->_tpl_vars['issue']->getFileName($this->_tpl_vars['coverLocale']) && ! $this->_tpl_vars['issue']->getHideCoverPageArchives($this->_tpl_vars['coverLocale'])): ?>
...
"<?php if ($this->_tpl_vars['issue']->getCoverPageAltText($this->_tpl_vars['coverLocale']) != ''): ?> alt="<?php echo ((is_array($_tmp=$this->_tpl_vars['issue']->getCoverPageAltText($this->_tpl_vars['coverLocale']))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>

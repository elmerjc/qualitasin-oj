...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip_tags', 'article/googlescholar.tpl', 12, false),array('modifier', 'escape', 'article/googlescholar.tpl', 12, false),array('modifier', 'date_format', 'article/googlescholar.tpl', 35, false),array('modifier', 'lower', 'article/googlescholar.tpl', 65, false),array('modifier', 'explode', 'article/googlescholar.tpl', 73, false),array('modifier', 'String_substr', 'article/googlescholar.tpl', 75, false),array('modifier', 'to_array', 'article/googlescholar.tpl', 82, false),array('function', 'url', 'article/googlescholar.tpl', 68, false),)), $this); ?>
...
<?php if (is_a ( $this->_tpl_vars['article'] , 'PublishedArticle' ) && $this->_tpl_vars['article']->getDatePublished()): ?>
	<?php $this->assign('datePublished', $this->_tpl_vars['article']->getDatePublished()); ?>
	<?php if ($this->_tpl_vars['datePublished'] && ( ! $this->_tpl_vars['issue']->getYear() || $this->_tpl_vars['issue']->getYear() == strftime ( '%Y' , strtotime ( $this->_tpl_vars['datePublished'] ) ) )): ?>

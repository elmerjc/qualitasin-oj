<?php /* Smarty version 2.6.26, created on 2018-06-30 12:03:20
...
<p><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'focusScopeDesc','key' => "manager.setup.focusAndScopeDescription"), $this);?>
</p>
<p>
...
<h4><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'reviewPolicy','key' => "manager.setup.reviewPolicy"), $this);?>
</h4>
...
<h4><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'reviewGuidelines','key' => "manager.setup.reviewGuidelines"), $this);?>
</h4>
...
<p>
	...
	<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'numWeeksPerReview','key' => "manager.setup.reviewOptions.numWeeksPerReview"), $this);?>
...
:<br />
		...
		<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'remindForInvite','key' => "manager.setup.reviewOptions.remindForInvite1"), $this);?>

		<select name="numDaysBeforeInviteReminder" id="numDaysBeforeInviteReminder" size="1" class="selectMenu"<?php if (! $this->_tpl_vars['remindForInvite'] || ! $this->_tpl_vars['scheduledTasksEnabled']): ?> disabled="disabled"<?php endif; ?>>
...
"<?php if ($this->_tpl_vars['numDaysBeforeInviteReminder'] == $this->_sections['inviteDayOptions']['index'] || ( $this->_sections['inviteDayOptions']['index'] == 5 && ! $this->_tpl_vars['remindForInvite'] )): ?> selected="selected"<?php endif; ?>><?php echo $this->_sections['inviteDayOptions']['index']; ?>
		...
		<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'numDaysBeforeInviteReminder','key' => "manager.setup.reviewOptions.remindForInvite2"), $this);?>
		...
		<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'remindForSubmit','key' => "manager.setup.reviewOptions.remindForSubmit1"), $this);?>

		<select name="numDaysBeforeSubmitReminder" id="numDaysBeforeSubmitReminder" size="1" class="selectMenu"<?php if (! $this->_tpl_vars['remindForSubmit'] || ! $this->_tpl_vars['scheduledTasksEnabled']): ?> disabled="disabled"<?php endif; ?>>
...
"<?php if ($this->_tpl_vars['numDaysBeforeSubmitReminder'] == $this->_sections['submitDayOptions']['index']): ?> selected="selected"<?php endif; ?>><?php echo $this->_sections['submitDayOptions']['index']; ?>
		...
		<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'numDaysBeforeSubmitReminder','key' => "manager.setup.reviewOptions.remindForSubmit2"), $this);?>
...
<h3>2.3 <?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'privacyStatement','key' => "manager.setup.privacyStatement"), $this);?>
</h3>
...
<?php echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'manager','op' => 'plugins','path' => 'generic'), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'genericPluginsUrl') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'genericPluginsUrl'));?>

<p><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.setup.lockssDescription",'genericPluginsUrl' => $this->_tpl_vars['genericPluginsUrl']), $this);?>
</p>
...
<p>
	...
	<br />
	<span class="instruct"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'lockssLicense','key' => "manager.setup.lockssLicenses"), $this);?>
</span>
</p>
</div>

<?php /* Smarty version 2.6.26, created on 2018-05-26 10:27:54
         compiled from manager/setup/step3.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'manager/setup/step3.tpl', 13, false),array('function', 'fieldLabel', 'manager/setup/step3.tpl', 20, false),array('function', 'form_language_chooser', 'manager/setup/step3.tpl', 23, false),array('function', 'translate', 'manager/setup/step3.tpl', 24, false),array('function', 'load_url_in_div', 'manager/setup/step3.tpl', 395, false),array('function', 'fbvElement', 'manager/setup/step3.tpl', 402, false),array('modifier', 'assign', 'manager/setup/step3.tpl', 22, false),array('modifier', 'escape', 'manager/setup/step3.tpl', 37, false),array('modifier', 'translate', 'manager/setup/step3.tpl', 132, false),)), $this); ?>
...
<h3>3.1 <?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'authorGuidelines','key' => "manager.setup.authorGuidelines"), $this);?>
</h3>
...
<h4><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'copyrightNotice','key' => "manager.setup.authorCopyrightNotice"), $this);?>
</h4>
...
" />
	...
	<tr valign="top">
		<td class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'licenseURLSelect','key' => "submission.licenseURL"), $this);?>
</td>
		<td class="value">
...
" <?php if ($this->_tpl_vars['foundCc']): ?>readonly="readonly" <?php endif; ?>size="40" maxlength="255" class="textField" />
			<br />
			<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'licenseURL','key' => "manager.setup.licenseURLDescription"), $this);?>
...
<h4><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'competingInterestGuidelines','key' => "manager.setup.competingInterests.guidelines"), $this);?>
</h4>
...
" size="60" class="textField" />
			<br />
			<span class="instruct"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'metaDisciplineExamples','key' => "manager.setup.disciplineExamples"), $this);?>
</span>
		</td>
	</tr>
...
" size="60" class="textField" />
			<br />
			<span class="instruct"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'metaSubjectExamples','key' => "manager.setup.subjectExamples"), $this);?>
</span>
		</td>
	</tr>
...
" size="60" class="textField" />
			<br />
			<span class="instruct"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'metaCoverageGeoExamples','key' => "manager.setup.coverageGeoExamples"), $this);?>
</span>
		</td>
	</tr>
	<tr>
...
" size="60" class="textField" />
			<br />
			<span class="instruct"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'metaCoverageChronExamples','key' => "manager.setup.coverageChronExamples"), $this);?>
</span>
		</td>
	</tr>
	<tr>
...
" size="60" class="textField" />
			<br />
			<span class="instruct"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'metaCoverageResearchSampleExamples','key' => "manager.setup.coverageResearchSampleExamples"), $this);?>
</span>
		</td>
	</tr>
...
" size="60" class="textField" />
			<br />
			<span class="instruct"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'metaTypeExamples','key' => "manager.setup.typeExamples"), $this);?>
</span>
		</td>
	</tr>
</table>
...
<table width="100%" class="data">
	...
	<tr valign="top">
		...
		<td class="value">
			<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'copySubmissionAckSpecified','key' => "manager.setup.notifications.copySpecifiedAddress"), $this);?>
<br />
			<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'copySubmissionAckAddress','key' => "user.email"), $this);?>

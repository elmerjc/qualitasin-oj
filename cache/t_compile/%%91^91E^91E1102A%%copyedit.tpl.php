...
<table class="data" width="100%">
	<tr>
		...
		<td class="label" width="80%"><?php if ($this->_tpl_vars['submission']->getUserIdBySignoffType('SIGNOFF_COPYEDITING_INITIAL')): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['copyeditor']->getFullName())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
<table width="100%" class="info">
	<tr>
		<td width="40%" colspan="2"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'viewMetadata','path' => $this->_tpl_vars['submission']->getId()), $this);?>

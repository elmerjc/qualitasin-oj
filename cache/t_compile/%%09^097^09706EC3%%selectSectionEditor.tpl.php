<?php /* Smarty version 2.6.26, created on 2018-06-30 14:10:40
...
<h3><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "editor.article.selectEditor",'roleName' => ((is_array($_tmp=$this->_tpl_vars['roleName'])) ? $this->_run_mod_handler('translate', true, $_tmp) : AppLocale::translate($_tmp))), $this);?>
</h3>

<form id="submit" method="post" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'assignEditor','path' => $this->_tpl_vars['rolePath'],'articleId' => $this->_tpl_vars['articleId']), $this);?>
">

...
&nbsp;&nbsp;&nbsp;&nbsp;
		<?php if (! $this->_tpl_vars['confirmedStatus']): ?>
			...
			<?php if (! $this->_tpl_vars['submission']->getCancelled()): ?>
				<a href="<?php echo $this->_tpl_vars['acceptUrl']; ?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "reviewer.article.canDoReview"), $this);?>
</a> <?php echo $this->_plugins['function']['icon'][0][0]->smartyIcon(array('name' => 'mail','url' => $this->_tpl_vars['acceptUrl']), $this);?>

				&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="<?php echo $this->_tpl_vars['declineUrl']; ?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "reviewer.article.cannotDoReview"), $this);?>
</a> <?php echo $this->_plugins['function']['icon'][0][0]->smartyIcon(array('name' => 'mail','url' => $this->_tpl_vars['declineUrl']), $this);?>
...
" class="icon">
					...
					<?php echo $this->_plugins['function']['icon'][0][0]->smartyIcon(array('name' => 'comment'), $this);?>
	...
	<td>
		<table class="data" width="100%">
			<tr valign="top">
				...
				<?php else: ?>
					<form id="recommendation" method="post" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'recordRecommendation'), $this);?>
">
					<input type="hidden" name="reviewId" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['reviewId'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" />

<?php /* Smarty version 2.6.26, created on 2018-05-26 10:36:44
...
" onclick="togglePublishingMode(this.form)"<?php if ($this->_tpl_vars['publishingMode'] == @PUBLISHING_MODE_OPEN): ?> checked="checked"<?php endif; ?> />
		...
		<td width="95%" class="value">
			...
			<h4><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'openAccessPolicy','key' => "manager.setup.openAccessPolicy"), $this);?>
</h4>
...
<h4><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'pubFreqPolicy','key' => "manager.setup.publicationSchedule"), $this);?>
</h4>
...
<p>
	...
	<select name="numAnnouncementsHomepage" id="numAnnouncementsHomepage" size="1" class="selectMenu" <?php if (! $this->_tpl_vars['enableAnnouncementsHomepage']): ?>disabled="disabled"<?php endif; ?>>
...
"<?php if ($this->_tpl_vars['numAnnouncementsHomepage'] == $this->_sections['numAnnouncementsHomepageOptions']['index'] || ( $this->_sections['numAnnouncementsHomepageOptions']['index'] == 1 && ! $this->_tpl_vars['numAnnouncementsHomepage'] )): ?> selected="selected"<?php endif; ?>><?php echo $this->_sections['numAnnouncementsHomepageOptions']['index']; ?>
	...
	<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'numAnnouncementsHomepage','key' => "manager.setup.enableAnnouncementsHomepage2"), $this);?>

</p>
<div id="announcementsIntroductionSection">
<h4><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'announcementsIntroduction','key' => "manager.setup.announcementsIntroduction"), $this);?>
</h4>
...
<h4><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'copyeditInstructions','key' => "manager.setup.copyeditInstructions"), $this);?>
</h4>
...
<h4><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'layoutInstructions','key' => "manager.setup.layoutInstructions"), $this);?>
</h4>
...
<h4><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'refLinkInstructions','key' => "manager.setup.refLinkInstructions.description"), $this);?>
</h4>
...
<h4><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'proofInstructions','key' => "manager.setup.proofingInstructions"), $this);?>
</h4>

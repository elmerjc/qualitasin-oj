<?php /* Smarty version 2.6.26, created on 2018-06-30 15:11:39
...
" size="30" maxlength="90" class="textField" /></td>
	...
	<tr valign="top">
		<td class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => "authors-".($this->_tpl_vars['authorIndex'])."-orcid",'key' => "user.orcid"), $this);?>
</td>
		<td class="value"><input type="text" name="authors[<?php echo ((is_array($_tmp=$this->_tpl_vars['authorIndex'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
" size="30" maxlength="90" class="textField" /><br /><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.orcid.description"), $this);?>
</td>
	</tr>
	<tr valign="top">
...
" size="60" class="textField" /></td>
	...
	<tr valign="top">
		<td class="label"><?php if ($this->_tpl_vars['section'] && $this->_tpl_vars['section']->getAbstractsNotRequired() == 0): ?><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'abstract','required' => 'true','key' => "article.abstract"), $this);?>
...
<table width="100%" class="data">
	<tr valign="top">
		<td width="20%" class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'copyrightHolder','key' => "submission.copyrightHolder"), $this);?>
</td>
		<td width="80%" class="value"><input type="text" name="copyrightHolder[<?php echo ((is_array($_tmp=$this->_tpl_vars['formLocale'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
" size="60" maxlength="255" class="textField" /></td>
	...
	<tr valign="top">
		<td class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'copyrightYear','key' => "submission.copyrightYear"), $this);?>
</td>
		<td class="value"><input type="text" name="copyrightYear" id="copyrightYear" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['copyrightYear'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" size="10" maxlength="255" class="textField" /></td>
	...
	<tr valign="top">
		...
		<td class="value"><input type="text" name="licenseURL" id="licenseURL" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['licenseURL'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" size="60" maxlength="255" class="textField" /></td>
	</tr>
</table>

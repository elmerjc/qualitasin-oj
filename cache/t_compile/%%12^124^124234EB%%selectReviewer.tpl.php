<?php /* Smarty version 2.6.26, created on 2018-06-30 14:13:36
         compiled from sectionEditor/selectReviewer.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'sectionEditor/selectReviewer.tpl', 30, false),array('function', 'url', 'sectionEditor/selectReviewer.tpl', 31, false),array('function', 'html_options_translate', 'sectionEditor/selectReviewer.tpl', 35, false),array('function', 'sort_search', 'sectionEditor/selectReviewer.tpl', 57, false),array('function', 'math', 'sectionEditor/selectReviewer.tpl', 92, false),array('function', 'page_info', 'sectionEditor/selectReviewer.tpl', 120, false),array('function', 'page_links', 'sectionEditor/selectReviewer.tpl', 121, false),array('modifier', 'escape', 'sectionEditor/selectReviewer.tpl', 42, false),array('modifier', 'string_format', 'sectionEditor/selectReviewer.tpl', 78, false),array('modifier', 'date_format', 'sectionEditor/selectReviewer.tpl', 97, false),array('modifier', 'default', 'sectionEditor/selectReviewer.tpl', 98, false),array('modifier', 'to_array', 'sectionEditor/selectReviewer.tpl', 102, false),array('block', 'iterate', 'sectionEditor/selectReviewer.tpl', 69, false),)), $this); ?>
...
<form id="submit" method="post" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'selectReviewer','path' => $this->_tpl_vars['articleId']), $this);?>
">
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['reviewer']->getFullName())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
	...
	<td><?php echo ((is_array($_tmp=$this->_tpl_vars['reviewer']->getInterestString())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</td>
...
<?php else: ?>&mdash;<?php endif; ?></td>
	...
	<td>
		<?php if ($this->_tpl_vars['reviewer']->review_id): ?>
			<?php if ($this->_tpl_vars['reviewer']->declined): ?>
				<a class="action" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'reassignReviewer','path' => ((is_array($_tmp=$this->_tpl_vars['articleId'])) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['reviewer']->getUserId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['reviewer']->getUserId()))), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "editor.reassign"), $this);?>
</a>
			<?php else: ?>

<?php /* Smarty version 2.6.26, created on 2018-05-26 10:23:55
...
<table width="100%" class="data">
	<tr valign="top">
		<td width="20%" class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'homeHeaderLogoImage','key' => "manager.setup.useImageLogo"), $this);?>
</td>
		<td width="80%" class="value"><input type="file" name="homeHeaderLogoImage" id="homeHeaderLogoImage" class="uploadField" /> <input type="submit" name="uploadHomeHeaderLogoImage" value="<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.upload"), $this);?>
" class="button" /></td>
	</tr>
</table>
...
<table width="100%" class="data">
	<tr valign="top">
		<td width="20%" class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'journalThumbnail','key' => "manager.setup.useThumbnail"), $this);?>
</td>
		<td width="80%" class="value"><input type="file" name="journalThumbnail" id="journalThumbnail" class="uploadField" /> <input type="submit" name="uploadJournalThumbnail" value="<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.upload"), $this);?>
" class="button" /></td>
	</tr>
</table>
...
<table width="100%" class="data">
	<tr valign="top">
		<td width="20%" class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'journalThumbnailAltText','key' => "common.altText"), $this);?>
</td>
		<td width="80%" class="value"><input type="text" name="journalThumbnailAltText[<?php echo ((is_array($_tmp=$this->_tpl_vars['formLocale'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
<h4><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'description','key' => "manager.setup.journalDescription"), $this);?>
</h4>
...
<table width="100%" class="data">
	<tr valign="top">
		<td width="20%" class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'homepageImage','key' => "manager.setup.homepageImage"), $this);?>
</td>
		<td width="80%" class="value"><input type="file" name="homepageImage" id="homepageImage" class="uploadField" /> <input type="submit" name="uploadHomepageImage" value="<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.upload"), $this);?>
" class="button" /></td>
	</tr>
</table>
...
<h4><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'additionalHomeContent','key' => "manager.setup.additionalContent"), $this);?>
</h4>
...
<table width="100%" class="data">
	<tr valign="top">
		<td width="20%" class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'pageHeaderLogoImage','key' => "manager.setup.useImageLogo"), $this);?>
</td>
		<td width="80%" class="value"><input type="file" name="pageHeaderLogoImage" id="pageHeaderLogoImage" class="uploadField" /> <input type="submit" name="uploadPageHeaderLogoImage" value="<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.upload"), $this);?>
" class="button" /></td>
	</tr>
</table>
...
<table width="100%" class="data">
	<tr valign="top">
		<td width="20%" class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'journalFavicon','key' => "manager.setup.useImageLogo"), $this);?>
</td>
		<td width="80%" class="value"><input type="file" name="journalFavicon" id="journalFavicon" class="uploadField" /> <input type="submit" name="uploadJournalFavicon" value="<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.upload"), $this);?>
" class="button" /></td>
	</tr>
</table>
...
<h4><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'journalPageHeader','key' => "manager.setup.alternateHeader"), $this);?>
</h4>
...
<h3>5.4 <?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'journalPageFooter','key' => "manager.setup.journalPageFooter"), $this);?>
</h3>
...
<table id="assignBlocksToSidebars" border="0" align="center" style="width: 100%;">
	<tr align="center">
		<td rowspan="2" id="assignBlocksToSidebarLeft" style="with: 30%;" >
			<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'blockSelectLeftWidget','key' => "manager.setup.layout.leftSidebar"), $this);?>
<br />
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['block']->getDisplayName())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
		...
		<td valign="top" id="assignBlocksToSidebarUnselected" style="width: 30%;" >
			<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'blockUnselectedWidget','key' => "manager.setup.layout.unselected"), $this);?>
<br />
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['block']->getDisplayName())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
		...
		<td rowspan="2" id="assignBlocksToSidebarRight" style="width: 30%;">
			<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'blockSelectRightWidget','key' => "manager.setup.layout.rightSidebar"), $this);?>
<br />
...
<div id="infoForReaders"><h4><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'readerInformation','key' => "manager.setup.information.forReaders"), $this);?>
</h4>
...
<div id="infoForAuth"><h4><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'authorInformation','key' => "manager.setup.information.forAuthors"), $this);?>
</h4>
...
<div id="infoForLibs"><h4><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'librarianInformation','key' => "manager.setup.information.forLibrarians"), $this);?>
</h4>
...
<table width="100%" class="data">
	<tr valign="top">
		<td width="20%" class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'itemsPerPage','key' => "manager.setup.itemsPerPage"), $this);?>
</td>
		<td width="80%" class="value"><input type="text" size="3" name="itemsPerPage" id="itemsPerPage" class="textField" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['itemsPerPage'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" /></td>
	</tr>
	<tr valign="top">
		<td width="20%" class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'numPageLinks','key' => "manager.setup.numPageLinks"), $this);?>
</td>
		<td width="80%" class="value"><input type="text" size="3" name="numPageLinks" id="numPageLinks" class="textField" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['numPageLinks'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" /></td>
	</tr>
</table>
</div>

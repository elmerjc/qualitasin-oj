<?php /* Smarty version 2.6.26, created on 2018-06-30 20:30:40
         compiled from editor/issues/proofIssueGalleyTop.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'editor/issues/proofIssueGalleyTop.tpl', 15, false),array('modifier', 'escape', 'editor/issues/proofIssueGalleyTop.tpl', 17, false),array('function', 'translate', 'editor/issues/proofIssueGalleyTop.tpl', 18, false),array('function', 'url', 'editor/issues/proofIssueGalleyTop.tpl', 40, false),)), $this); ?>
<?php echo '<?xml'; ?>
...
<body>
	<table width="100%" height="100%">
		<tr>
			<td align="center">
				<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'issueGalleys','path' => $this->_tpl_vars['issueId']), $this);?>
" target="_top"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "editor.issues.backToIssueGalleys"), $this);?>
</a>
			</td>
		</tr>
	</table>

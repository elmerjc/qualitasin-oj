<?php /* Smarty version 2.6.26, created on 2018-05-10 09:44:33
         compiled from user/register.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'user/register.tpl', 18, false),array('function', 'translate', 'user/register.tpl', 18, false),array('function', 'fieldLabel', 'user/register.tpl', 56, false),array('function', 'form_language_chooser', 'user/register.tpl', 59, false),array('function', 'html_options_translate', 'user/register.tpl', 139, false),array('function', 'html_options', 'user/register.tpl', 197, false),array('modifier', 'assign', 'user/register.tpl', 26, false),array('modifier', 'escape', 'user/register.tpl', 48, false),array('modifier', 'nl2br', 'user/register.tpl', 260, false),)), $this); ?>
...
" id="password" size="20" class="textField" /></td>
	</tr>
...
" size="30" maxlength="90" class="textField" /></td>
		...
		<tr valign="top">
			...
			<td class="value"><input type="text" id="orcid" name="orcid" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['orcid'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" size="40" maxlength="255" class="textField" /><br /><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.orcid.description"), $this);?>
</td>
		</tr>

<?php /* Smarty version 2.6.26, created on 2018-06-30 13:41:02
...
&nbsp;&nbsp;
				...
				<?php if ($this->_tpl_vars['datePublished']): ?>
					...
					<?php echo ((is_array($_tmp=smarty_function_math(array('equation' => "min(x,y)-50",'x' => $this->_tpl_vars['publishedYear'],'y' => $this->_tpl_vars['currentYear']), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'minYear') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'minYear'));?>

<?php /* Smarty version 2.6.26, created on 2018-04-21 19:21:08
...
<form method="post" id="install" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'install'), $this);?>
">
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['localeName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
 (<?php echo ((is_array($_tmp=$this->_tpl_vars['localeKey'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
			...
			<?php if ($this->_tpl_vars['incompleteLocaleFound']): ?>
				<br />
				<span class="pkp_form_error">*</span>&nbsp;<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "installer.locale.maybeIncomplete"), $this);?>
...
" size="20" class="textField" /></td>
	...
	<tr valign="top">
		<td></td>
		<td><span class="instruct"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.register.passwordLengthRestriction",'length' => $this->_tpl_vars['passwordLength']), $this);?>
</span></td>
	</tr>
	<tr valign="top">
		<td class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'adminPassword2','key' => "user.repeatPassword"), $this);?>
</td>
...
<div id="oaiSettings">
<h3><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "installer.oaiSettings"), $this);?>
</h3>
...
<div id="beaconDiv">
	<h3><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "installer.beacon"), $this);?>
</h3>
	...
	<table width="100%" class="data">
		<tr valign="top">
			...
			<td width="80%" class="value">
				<input type="checkbox" name="enableBeacon" id="enableBeacon" <?php if ($this->_tpl_vars['enableBeacon']): ?>checked="checked" <?php endif; ?>/>
				<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'enableBeacon','key' => "installer.beacon.enable"), $this);?>
...
<p><input name="install" type="button" id="install" value="<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "installer.installApplication"), $this);?>
" class="button defaultButton" onclick="doSubmit()" /></p>

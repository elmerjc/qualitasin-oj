<?php return array (
  ...
  'manager.groups.context.editorialTeam' => 'Mostrar el título (p. ej. Editor/a) debajo del apartado Equipo editorial en la sección Equipo humano de la sección Acerca de la revista',
  'manager.groups.context.editorialTeam.short' => 'Equipo editorial',
  'manager.groups.context.people' => 'Mostrar el título como una categoría debajo del apartado Equipo humano (p. ej. Consejo editorial)',
  'manager.groups.create' => 'Crear un título para el cargo',
  'manager.groups.disableBoard' => 'Hacer que OJS muestre las personas que pertenecen al Equipo editorial según el rol que tienen asignado (gestor/a de la revista, corrector/a de originales, etc.)',
  'manager.groups.enableBoard' => 'Establecer que el gestor/a de la revista cree títulos e incluya a las personas dentro de cada uno de ellos.',
  'manager.groups.enableBoard.description' => 'Debajo del apartado <a href="{$aboutEditorialTeamUrl}">Equipo humano</a> en la sección Acerca de la revista:',
  'manager.groups.noneCreated' => 'No se creó ningún cargo en el Equipo editorial.',
  ...
  'manager.payment.giftFees' => 'Donación de cuotas',
  'manager.payment.giftFeesDescription' => 'Un enlace de donación de suscripciones aparecerá en la página de suscripciones en la sección Acerca de la revista y como elemento del bloque de la barra lateral de suscripciones.',
  'manager.payment.generalFees' => 'Cuotas generales',
  'manager.payment.generalFeesDescription' => 'La sección de Miembros de la asociación se mostrará en la sección Acerca de la revista, debajo de Políticas, y el enlace para realizar donaciones aparecerá sobre el buscador, en la parte derecha de la ventana.',
  ...
  'manager.payment.options.acceptGiftSubscriptionPayments' => 'Esta opción activa el pago para donación de suscripciones y permite a los lectores/as de la revista comprar donaciones de suscripciones para otros lectores/as.',
  ...
  'manager.payment.options.submissionFee' => 'Enviar un artículo',
  ...
  'manager.plugins.copyError' => 'El módulo no se copió correctamente. Esto puede deberse a un problema de permisos. Asegúrese de que el servidor web puede escribir en el directorio y los subdirectorios de los módulos. No olvide volver a protegerlo después.',
  ...
  'manager.plugins.deleteError' => 'El módulo no se pudo eliminarse del sistema de archivos. Esto puede deberse a un problema de permisos. Asegúrese de que el servidor web puede escribir en el directorio y los subdirectorios de los módulos. No olvide volver a protegerlo después.',
  'manager.plugins.deleteSuccess' => 'El módulo se eliminó correctamente',
  'manager.plugins.description' => 'Esta página permite al gestor/a de la revista revisar y configurar los módulos instalados. Estos se dividen en distintas categorías según su función. A continuación, se muestran las diferentes categorías y los módulos que pertenecen a cada una de ellas.',
  'manager.plugins.doesNotExist' => 'El módulo no existe',
  'manager.plugins.fileSelectError' => 'Seleccione un archivo primero',
  'manager.plugins.install' => 'Instalar un nuevo módulo',
  'manager.plugins.installDescription' => 'Este formulario permite cargar e instalar un nuevo módulo. Asegúrese de que el módulo está comprimido en formato .tar.gz.',
  ...
  'manager.plugins.installFailed' => 'El proceso de instalación falló',
  'manager.plugins.installSuccessful' => 'La versión se instaló correctamente',
  ...
  'manager.plugins.pleaseInstall' => 'El módulo no existe. Debe instalarlo. Proceda a la instalación',
  'manager.plugins.pleaseUpgrade' => 'El módulo ya existe, pero se trata de una versión posterior a la que está instalada. Debe actualizarlo',
  ...
  'manager.plugins.upgradeDescription' => 'Este formulario permite actualizar un módulo. Asegúrese de que el módulo está comprimido en formato .tar.gz.',
  'manager.plugins.upgradeFailed' => 'El proceso de actualización falló',
  'manager.plugins.upgradeSuccessful' => 'El proceso de actualización finalizó correctamente',
  ...
  'manager.reviewFormElement.changeType' => 'Advertencia: Cambiar el tipo de elemento del formulario de revisión de elección múltiple a inconcluso conllevará la eliminación de las opciones de elección múltiple.',
  ...
  'manager.reviewFormElements.dropdownbox' => 'Cuadro desplegable',
  ...
  'manager.reviewFormElements.noneCreated' => 'No se creó ningún elemento del formulario.',
  'manager.reviewFormElements.possibleResponse' => 'Selección',
  'manager.reviewFormElements.question' => 'Elemento',
  'manager.reviewFormElements.radiobuttons' => 'Botones de selección (sólo puede elegir uno)',
  ...
  'manager.reviewForms.noneChosen' => 'Ningún formulario de revisión gratuito',
  'manager.reviewForms.noneCreated' => 'No se creó ningún formulario de revisión.',
  ...
  'manager.setup.additionalContentDescription' => 'La información que introduzca aquí se mostrará justo debajo de la imagen (si existe) de la página inicial. Puede utilizar tanto texto como HTML.',
  ...
  'manager.setup.announcementsDescription' => 'Pueden publicarse avisos para informar a los lectores/as sobre noticias y eventos de la revista. Estos se mostrarán en la página Avisos.',
  ...
  'manager.setup.contributorsDescription' => 'En la sección Acerca de la revista, se hace mención de los organismos u organizaciones que proporcionan ayuda financiera o "en especie" a la revista; en algunos casos, se adjunta una nota de agradecimiento.',
  ...
  'manager.setup.copyeditInstructions' => 'Instrucciones de corrección de originales',
  ...
  'manager.setup.copyrightNotice' => 'Aviso de derechos de autor/a',
  ...
  'manager.setup.coverageChronProvideExamples' => 'Proporcione ejemplos de términos cronológicos o históricos relevantes',
  'manager.setup.coverageDescription' => 'Se refiere a la localización geográfica, a la cobertura cronológica o histórica o a las características de la muestra de investigación.',
  ...
  'manager.setup.coverageResearchSampleProvideExamples' => 'Proporcione ejemplos sobre las características de las muestras de la investigación para este campo',
  ...
  'manager.setup.editorialMembers' => 'Vaya a Miembros del consejo de redacción para añadir o modificar miembros del consejo de redacción o del consejo de revisión. Puede realizar esta acción en cualquier momento mientras trabaja con la revista.',
  ...
  'manager.setup.editorialProcess3' => 'El editor/a de gestión se encarga de la lista de envíos, de la edición de los envíos y de la tabla de contenidos, mientras que los editores/as de sección se encargan de revisar los envíos.',
  ...
  'manager.setup.emailBounceAddressDescription' => 'Si un correo electrónico no se puede enviar, se recibirá un mensaje de error en esta dirección.',
  'manager.setup.emailBounceAddressDisabled' => '<strong>Nota:</strong> Para activar esta opción, el administrador/a del sitio debe habilitar la opción <tt>allow_envelope_sender</tt> en el archivo de configuración de OJS. Es posible que se requiera una configuración adicional del servidor para admitir esta función (puede que no todos los servidores la permitan) siguiendo las indicaciones en la documentación del OJS.',
  'manager.setup.emails' => 'Identificación del correo electrónico',
  'manager.setup.emailSignature' => 'Firma',
  'manager.setup.emailSignatureDescription' => 'Las plantillas de correo que el sistema envíe en nombre de la revista llevarán esta firma al final. Es posible editar el cuerpo de estos correos en el apartado Gestión de la revista.',
  ...
  'manager.setup.enableAnnouncementsHomepage2' => 'los últimos avisos publicados en la página inicial.',
  ...
  'manager.setup.enablePublicArticleId' => 'Se usarán identificadores personalizados para identificar los elementos publicados.',
  'manager.setup.enablePublicGalleyId' => 'Se usarán identificadores personalizados para identificar las galeradas (p. ej., archivos HTML o PDF) de los elementos publicados.',
  'manager.setup.enablePublicIssueId' => 'Se usarán identificadores personalizados para identificar las publicaciones.',
  'manager.setup.enablePublicSuppFileId' => 'Se usarán identificadores personalizados para identificar los archivos artículos suplementarios.',
  ...
  'manager.setup.focusAndScopeOfJournal' => 'Objeto y alcance de la revista',
  'manager.setup.focusScope' => 'Enfoque y alcance',
  'manager.setup.focusScopeDescription' => '<strong>EJEMPLO DATOS HTML</strong>',
  ...
  'manager.setup.frequencyOfPublicationNote' => 'Nota: Deje en blanco los elementos que no se utilicen en su revista y los editores/as podrán restablecer los números en el proceso de publicación.',
  ...
  'manager.setup.homepageImage' => 'Imagen de la página inicial',
  'manager.setup.homepageImageDescription' => 'Añada una imagen o un gráfico en el centro de la página.',
  ...
  'manager.setup.journalFaviconDescription' => 'Añada un icono de favoritos para la revista. Éste se mostrará junto a la barra de navegación cuando los usuarios/as visiten su sitio web.',
  ...
  'manager.setup.journalPageHeaderDescription' => 'Es posible cargar una versión gráfica (.gif, .jpg o .png) del título y del logotipo de la revista, posiblemente una versión reducida de la utilizada en la página de inicio, para que ésta reemplace a la versión de texto y se muestre como encabezado en las páginas de la revista.',
  ...
  'manager.setup.layoutAndGalleys' => 'Maquetadores/as',
  'manager.setup.layoutInstructions' => 'Instrucciones de maquetación',
  'manager.setup.layoutInstructionsDescription' => 'Las instrucciones de maquetación se pueden aplicar al formato de los elementos publicados en la revista y se pueden cargar a continuación en formato HTML o texto plano. Estarán a disposición del maquetador/a y del editor/a de sección en la página de edición de cada envío. (Como cada revista posiblemente emplee sus propios formatos de archivo, estándares bibliográficos, hojas de estilo, etc., no se proporcionan instrucciones por defecto.)',
  ...
  'manager.setup.lockssEnable' => 'Habilite LOCKSS para almacenar y distribuir contenido de la revista en bibliotecas colaboradoras a través de una página del <a href="{$lockssUrl}" target="_blank">Manifiesto editorial</a> LOCKSS. Puede encontrar la licencia de LOCKSS en la sección Archivo de la sección Acerca de la revista:',
  'manager.setup.lockssLicenses' => 'Ver <a href="http://lockss.org/lockss/Publishers_and_Titles" target="_blank">otras versiones de una licencia LOCKSS</a>.',
  ...
  'manager.setup.notifications.submissionAckDisabled' => '<strong>Nota:</strong> Actualmente, el correo electrónico de confirmación está deshabilitado. Para utilizar esta función, habilite el correo electrónico de CONFIRMACIÓN en <a class="action" href="{$preparedEmailsUrl}">Correos preparados</a>.',
  ...
  'manager.setup.openAccessPolicyDescription' => 'Si la revista va a proporcionar acceso libre inmediato a todo el contenido publicado, debe establecer una política de acceso abierto, la cual aparecerá en el apartado Políticas de la sección Acerca de la revista.',
  ...
  'manager.setup.principalContactDescription' => 'Esta persona, que puede ocupar un cargo como director/a principal o administrador/a, aparecerá en la página inicial de la revista dentro de la sección Contacto, junto con la persona de contacto para cualquier tipo de asistencia técnica.',
  ...
  'manager.setup.privacyStatementDescription' => 'Esta declaración se mostrará en la sección Acerca de la revista, así como en las secciones Envío del autor/a y Notificación al iniciar sesión. A continuación, se proporciona una muestra de redacción de política de privacidad, que puede modificarse en cualquier momento.',
  ...
  'manager.setup.publicationFormatDescription' => 'La revista empleará los siguientes elementos para identificar un número (pueden reemplazarse para cada uno de los números).',
  ...
  'manager.setup.publisherNoteDescription' => 'Este texto aparecerá debajo del encabezado Editorial y encima del nombre y dirección URL de la editorial en el apartado Patrocinadores de la sección Acerca de la revista.',
  ...
  'manager.setup.registerJournalForIndexing' => 'Registrar la revista para la indexación (recopilación de metadatos)',
  ...
  'manager.setup.reviewOptions.noteOnModification' => 'Se puede modificar durante el proceso editorial.',
  ...
  'manager.setup.reviewProcessDescription' => 'OJS permite dos modelos para gestionar el proceso de revisión. Se recomienda el proceso de revisión estándar porque guía a los revisores/as a través del proceso, asegurando un historial de revisión completa para cada envío y saca provecho de las notificaciones de aviso automático y de las recomendaciones estándar para envíos (Aceptar; Aceptar con revisiones; Enviar para revisión; Enviar a otro lugar; Rechazar; Ver comentarios).<br /><br />Seleccione uno de los siguientes:',
  ...
  'manager.setup.reviewProcessStandardDescription' => 'Los editores/as pueden enviar por correo electrónico a los revisores/as seleccionados el título y el resumen del envío, así como una invitación para registrarse en el sitio web de la revista para completar la revisión. Además, estos/as deben iniciar sesión para aceptar el encargo de revisión, descargar envíos, realizar comentarios y seleccionar una recomendación.',
  ...
  'manager.setup.subjectClassificationURLValid' => 'Indique una URL remota válida (incluyendo http://).',
  ...
  'manager.setup.technicalSupportContact' => 'Persona de contacto para asistencias técnicas',
  ...
  'manager.statistics.reports.defaultReport.issueTableOfContents' => 'Visitas a la página de la tabla de contenidos del número',
  'manager.statistics.reports.defaultReport.issueTableOfContentsAndDownloads' => 'Tabla de contenidos del número y descargas',
  ...
  'manager.statistics.reports.advancedOptions.label' => 'Personalizar opciones de columnas, filtros y pedido. Si se cambia alguna de estas opciones, el resultado esperado de la plantilla de informe puede variar.',
  ...
  'manager.statistics.reports.reportUrl.label' => 'La siguiente URL puede utilizarse para crear el informe con la configuración del formulario actual. Sólo tiene que copiarla, pegarla en su navegador y entrar. Puede utilizar sus favoritos para almacenar el generador de URL de informe personalizado.',
  ...
  'manager.subscriptionPolicies.subscriptionPoliciesSaved' => 'La configuración de la política de suscripción se actualizó.',
  ...
  'manager.subscriptionTypes.form.membership' => 'Las suscripciones requieren información sobre la afiliación<br />(p. ej., de una asociación, organización, sociedad mercantil, etc.)',
  ...
  'manager.setup.permissions.display' => 'Display',
  'manager.setup.licenseURLDescription' => 'Si existe, proporciona la URL de la web de la del web de la licéncia.',
  'manager.setup.includeCopyrightStatement' => 'Muestra la declaración del copyright con el contenido (recomendable para mostrar los derechos de autor).',
  'manager.setup.includeLicense' => 'Mostar la licéncia con el trabajo publicado.',
  'manager.setup.resetPermissions' => 'Reinicia permisos de artículo',
  'manager.setup.resetPermissions.description' => 'La declaración del copyright y la información de la licencia se añadirán permanentemente al contenido publicado, garantizando que estos datos no cambian en caso de que lo hagan las políticas de la revista para los nuevos envíos. Para reiniciar la información almacenada de los permisos que ya se han adjuntado al contenido publicado, utiliza los botones que se muestran a continuación.',
  'manager.setup.confirmResetLicense' => 'Seguro que quieres reiniciar la licencia y la información del copyright adjunta al contenido publicado y remplazarla por la licencia actual de la revista?',
  'manager.statistics.reports.objectNotFound' => 'Objeto no encontrado en la base de datos',
  'manager.subscriptions.form.dateRemindedBefore' => 'Se ha enviado el recordatorio pre-vencimiento',
  'manager.subscriptions.form.dateRemindedAfter' => 'Se ha enviado el recordatorio post-vencimiento',
  'manager.setup.copyrightYearBasis' => 'Poner la fecha del copyright del artículo a',
  'manager.setup.copyrightYearBasis.Article' => 'El año por defecto se obtendrá de la fecha de publicación del número, como en "publicar sobre la marcha"',
  'manager.setup.copyrightYearBasis.Issue' => 'El año por defecto se obtendrá de la fecha de publicación del número.',
  'manager.setup.emailHeader' => 'Cabecera del correo electrónico',
  'manager.setup.confirmResetLicenseChanged' => 'Ha cambiado la información sobre licencia y copyright. Guarde los cambios antes de resetear los permisos.',
  'manager.setup.emailHeaderDescription' => 'Las plantillas de correo que son enviadas por el sistema a nombre de la revista comenzarán con la siguiente cabecera. Estos correos se enviarán a nombre del Contacto Principal de la revista, así que es importante aclarar que el Contacto Principal de la revista no es necesariamente el responsable del contenido del mensaje, que puede haber sido enviado por otro usuario pero llega a su nombre.',
